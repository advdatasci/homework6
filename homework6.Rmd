---
title: "Homework 6: Getting Data from Twitter"
output:
  html_document:
    highlight: tango
    number_sections: no
...
* Please include axis labels and plot titles on all plots
* This homework assignment may be completed in another programming language (like Python) if so please submit as a Juypyter Notebook viewable on Github 
* You are welcome and encouraged to discuss homework problems with others - however, you should cite their work/words/code if you end up using their approach. If you copy other's code/words directly or indirectly without attribution that will be considered plagiarism.  
...
for misinformation to spread. This is particularly concerning in light of
the Covid pandemic.
...
Read this paper: https://www.nature.com/articles/s41586-020-2281-1 that used Facebook data
to understand the patterns of pro and anti vax behavior on a social network. 
